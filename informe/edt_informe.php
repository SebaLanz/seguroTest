...
try{
        $oApi = new API();
        $informesMueP = $oApi->getMateriaUtilizadaEnPe($mp);   
    ...
    <script src="js/select2.min.js"> </script>
       ...
       <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Detalle de materias</li>
                    </ol>
                </nav>
                    <h1 class="h3 mb-2 text-gray-800">Detalle de Materias</h1>
                        ...
                        <div class="card-body">                            
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                              ...
                              <?php 
                                    ...
                                    foreach($informesMueP as $informe){ ?>
                                        <tr>
                                            <td><?php echo $informe->MpUtilizada;?></td>
                                            <td><?php echo $informe->nro_comprobante;?></td>
